...
export type PortalSignupPayload =
  | (z.infer<typeof portalSignupBaseSchema> & { role: "student"; profile: z.infer<typeof studentProfileSchema> })
  | (z.infer<typeof portalSignupBaseSchema> & { role: "tutor"; profile: z.infer<typeof tutorProfileSchema> });

export type PortalLoginPayload = z.infer<typeof portalLoginSchema>;
export type StudentProfileUpdatePayload = z.infer<typeof studentProfileUpdateSchema>;
export type TutorProfileUpdatePayload = z.infer<typeof tutorProfileUpdateSchema>;

export function parsePortalSignupPayload(input: unknown): PortalSignupPayload {
...
export function parsePortalProfileUpdatePayload(
  role: "student" | "tutor",
  input: unknown,
): { name?: string; profile: StudentProfileUpdatePayload | TutorProfileUpdatePayload } {
